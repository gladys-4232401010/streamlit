...
df_filtered = df[
    (df["department"].isin(department)) & # type: ignore
...
st.write(
    "Bagian ini berisi chart tambahan yang dibuat berdasarkan struktur data "
    "pada file customers.csv untuk membantu analisis data customer."
)import streamlit as st
import pandas as pd
import plotly.express as px
